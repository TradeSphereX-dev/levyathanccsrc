...
if not isfolder("levyathan") then
    makefolder("levyathan")
end

if not isfolder("levyathan/configs") then
    makefolder("levyathan/configs")
end

if not isfolder("levyathan/configs/da_hood") then
    makefolder("levyathan/configs/da_hood")
end
...
local nigga = (function() -- src/Lua/loader.lua
    ...
    function loaderOptions:new()
        ...
        InfoGame.BackgroundColor3 = Color3.fromRGB(16, 16, 16)
        InfoGame.Image = "rbxassetid://18550514517"
        ...
        if chosen_game == "da_hood" then
            (function() -- src/Lua/Scripts/da_hood/da_hood.lua
                ...
                if please_load then
                    ...
                    local Interface = UserInterface:Create{title = 'levyathan<font color="rgb(168, 157, 159)">.cc</font>',}
                    ...
                    do -- src/Lua/Scripts/da_hood/components/
                        ...
                        do -- src/Lua/Scripts/da_hood/components/c_render.lua
                            ...
                            do -- indicator
                                ...
                                local title = indicatorClass:new_indicator("levyathan.cc")
                        ...
                        do -- src/Lua/Scripts/da_hood/components/f_settings.lua
                            local config = {
                                path = "levyathan/configs/da_hood/",
                                file = "",
                                config_name = ""
                            }
                            function config:get_list()
                                ...
                                if #listfiles("levyathan/configs/da_hood") > 0 then
                                    for i, v in next, listfiles("levyathan/configs/da_hood") do
            ...
            (function() -- src/Lua/Scripts/universal/universal.lua
                ...
                do -- src/Lua/Scripts/universal/components/
                    ...
                    do -- src/Lua/Scripts/universal/components/b_render.lua
                        ...
                        local title = fucking_shitty_indicator:new_indicator("levyathan.cc")
                        aim_Ass_character.changecolor(Color3.fromRGB(255,255,255))
